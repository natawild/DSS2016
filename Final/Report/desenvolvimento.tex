...
desta classe solicita sempre uma conecção à base de Dados, este pedido é feito à classe \textit{Connector}, podendo este conetor estar configurado com Auto-Commit ou não dependendo do tipo de operações pretendidas.
...
Nesta especificação o utilizador tem a vantagem de aceder à lista de empréstimos, ou seja, consegue através da aplicação visualizar os valores que emprestou à casa para efetuar o pagmento de conta/despesa de outros moradores do apartamento previamente registados na aplicação, embora o morador que emprestou não tenha conhecimento a quem emprestou. 
